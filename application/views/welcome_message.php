...
<div id="main">
	...
	<div class="headerbar">
        ...
        <div class="headerbar-left">
			<a href="<?php echo site_url(''); ?>" class="logo"><img alt="logo" src="<?php echo base_url('assets/images/logo.png'); ?>" /> <span>Admin</span></a>
        </div>
	...
	<div class="left main-sidebar">
		...
		<div class="sidebar-inner leftscroll">
			...
			<ul>
					...
					<li class="submenu">
                        <a class="active" href="<?php echo site_url('baru'); ?>"><i class="fa fa-fw fa-area-chart"></i><span> Baru </span> </a>
                    </li>
